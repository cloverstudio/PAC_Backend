...
var MediaDuration = require('get-video-duration');
    ...
    router.post('', function (request, response) {
        ...
        async.waterfall([
            ...
            function (result, done) {
                ...
                MediaDuration(file.path).then((duration) => {
            ...
            function (result, done) {
                ...
                if (result.fileDuration)
                    newFile.duration = result.fileDuration;
            ...
            function (err, result) {
                ...
                if (err) {
                    ...
                    if (result.fileDuration)
                        responseJson.file.duration = result.fileDuration;
