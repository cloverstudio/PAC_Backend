...
**/
    ...
    router.get('/:page',tokenChecker,function(request,response){
        ...
        self.getList(0,page,request, response);
   ...
   /**
    ...
    router.get('/diff/:lastUpdate',tokenChecker,function(request,response){
        ...
        self.getList(request.params.lastUpdate ,0,request, response);
...
HistioryListController.prototype.getList = function(lastUpdate,page,request,response){
