...
var SearchHistoryAndMessagesController = function () {
}

_.extend(SearchHistoryAndMessagesController.prototype, BackendBase.prototype);

SearchHistoryAndMessagesController.prototype.init = function (app) {
    ...
    router.get('/', tokenChecker, function (request, response) {
        ...
        async.waterfall([
            ...
            function (done) {
                ...
                SearchHistoryLogic.search(0, 0, keyword, user, Const.pagingRowsHistoryAndMessages, (histories) => {
            ...
            function (result, done) {
                ...
                SearchMessageLogic.search(user, keyword, 0, Const.pagingRowsHistoryAndMessages, (messages) => {
...
module["exports"] = new SearchHistoryAndMessagesController();
