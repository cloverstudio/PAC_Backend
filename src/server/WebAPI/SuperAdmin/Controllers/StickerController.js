...
StickerController.prototype.init = function(app){
    ...
    router.get('/list', checkUserOwner, function(request, response) {
        ...
        var keyword = request.session.stickerKeyword;
        ...
        async.waterfall([
            ...
            function(done){
                ...
                var criteria = {};
                criteria.organizationId = { $exists: false };
        ...
        function(err,result){
            ...
            templateParams.paging = {
                ...
                baseURL : "/owner/sticker/list?page="
                
            }
            
            if(request.query.delete){
                templateParams.successMessage = self.l10n('The sticker is succesfully deleted.');
            }
    ...
    router.all('/search', checkUserOwner, function(request,response){
        ...
        request.session.stickerKeyword = keyword;
            
        response.redirect('/owner/sticker/list');  
    ...
    router.get('/delete/:_id', checkUserOwner, function(request,response){
    ...
    router.post('/delete/:_id', checkUserOwner, function(request, response) {
        ...
        function(err, result) {
            ...
            response.redirect('/owner/sticker/list?delete=1');
    ...
    async.waterfall([
        ...
        function(done) {
            ...
            if (!isEdit) {
                ...
                // check duplication
                model.findOne({ name: Utils.getCIString(formValues.name) }, function(err, findResult) {
