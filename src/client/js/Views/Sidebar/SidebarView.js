...
var SidebarView = Backbone.View.extend({
    ...
    onLoad: function () {
        ...
        _.debounce(function () {
            ...
            var lastOpenChatId = localStorage.get(Const.LocalStorageKeyLastOpenChatId)
            var lastOpenSidebarTab = localStorage.get(Const.LocalStorageKeyLastOpenSidebarTab)

            switch (lastOpenSidebarTab) {

                case Const.sidebarTab.groups:

                    groupListView.startChat(lastOpenChatId);
                ...
                case Const.sidebarTab.users:

                    userListView.startChat(lastOpenChatId);
                ...
                default:
                    historyListView.startChat(lastOpenChatId);
            }
