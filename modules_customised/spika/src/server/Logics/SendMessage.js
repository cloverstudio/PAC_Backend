...
var SendMessage = {
    execute : function(userID,param,onSucess,onError){
        ...
        UserModel.findUserbyId(userID,function (err,user) {
            ...
            if(objMessage.type == Const.messageTypeText && param.encrypted){
                objMessage.message = BridgeManager.hook('decryptMessage',objMessage.message);
            }
            ...
            newMessage.save(function(err,message){
                ...
                MessageModel.populateMessages(message,function (err,data) {
                    ...
                    if(sendData.type == Const.messageTypeText){
                        var encryptedMessage = BridgeManager.hook('encryptMessage',sendData.message);
