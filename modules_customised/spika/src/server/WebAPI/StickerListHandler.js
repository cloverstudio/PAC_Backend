...

{
    ...
    */
    ...
    router.get('',tokenChecker,function(request,response){
        ...
        BridgeManager.hook('stickerURL',request.user,function(stickerURL){
            ...
            // get base url
            var baseURL = Settings.options.protocol.replace('://','') + '://' + request.get('host');
            
            Request(baseURL + stickerURL, function (error, responseAPI, body) {
                    ...
                    if(obj && obj.data && obj.data.stickers){
                        ...
                        var mappedList = _.map(list,function(group){
                            ...
                            var stickers = {
                                ...
                                mainPic : baseURL + group.mainTitlePic
                            ...
                            var list = _.map(group.list,function(row){
                                ...
                                return {
                                    fullPic:baseURL + row.fullPic,
                                    smallPic:baseURL + row.smallPic
                                }
