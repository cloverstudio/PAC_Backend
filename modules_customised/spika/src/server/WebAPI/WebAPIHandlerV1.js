...
var WebAPIHandler ={
    ...
    init: function(app,express){
        ...
        app.use(bodyParser.json({ parameterLimit: 100, limit: '2gb' }));
        
        
        //bodyParser.urlencoded({ extended: true, parameterLimit: 100, limit: '1mb' })
        ...
        */
        ...
        router.use("/message/listall", require('./AllMessageListHandler').router);
